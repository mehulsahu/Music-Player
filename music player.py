...
master.title("Mehul Music player")
widget_width = 640
windget_lenght = 420
...
f1=Frame(master,bg="red",borderwidth=6,relief=SUNKEN)
...
# PLay_entry = Entry(master, textvariable="mansi",font="comicsansms 15",width=40,borderwidth=2)
# PLay_entry.pack(side=TOP, anchor='nw')

#buttons=------------------------------------

play_button = Button(master, text="Play",fg="blue",bg="powderblue" ,width=2, height=1,font="verdana 15 bold",padx=30,command=play)
play_button.config()
play_button.pack(side=LEFT,padx=5)

next_button = Button(master, text="Next", fg="blue", bg="red", width=2, height=1, font="verdana 15 bold", padx=30,command=next_song).pack(side=LEFT,padx=5)

previous_button = Button(master, text="Previous", fg="blue", bg="green", width=2, height=1, font="verdana 15 bold", padx=30,command=previous_song).pack(side=LEFT,padx=5)
...
suffle_button = Checkbutton(master, text="Shuffle", fg="blue",width=2, height=1, font="verdana 15 bold", padx=30).pack(side=LEFT)
